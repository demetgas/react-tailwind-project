...
export const ReadMore = () => {
  return (
    <div className="max-w-[1900px] mt-40 mx-auto lg:h-[20svh] md:h-[30svh] s:h-[50svh] items-center">
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-[50px]">
        ...
        <div className=" mx-auto   text-center">
          ...
          <div className="grid lg:grid-cols-1 md:grid-cols-3 lg:w-[20svw] md:w-[100svw] sm:w-[40svw] gap-6 mt-6 mx-auto">
            <div className="border-8  h-auto border-babyblue rounded p-4 hover:scale-110  transition-all delay-75 cursor-pointer">
            ...
            <div className="border-8  h-auto border-babyblue rounded p-4 hover:scale-110  transition-all delay-75 cursor-pointer">
              ...
              <p className="text-lg md:text-xl">
                ...
                and noted how they possess a timeless appeal to humans. Chris's
                words reflect the profound admiration many people have for these
                enigmatic felines.
              </p>
            </div>
            <div className="border-8  h-auto border-babyblue rounded p-4 hover:scale-110  transition-all delay-75 cursor-pointer">
              ...
              <p className="text-lg md:text-xl">
                In another insightful comment, Anna echoed the sentiments of
                admiration for cats' enigmatic gaze and graceful movements. His
                words underscore the profound impact these creatures have on
