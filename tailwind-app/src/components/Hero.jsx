    ...
    <div className="relative w-full h-[78.5vh]">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 absolute inset-0">
        <div className="flex items-center justify-center p-4 text-white ">
          <div className="xs:mb-10 mb-0">
            <h1 className="lg:text-[70px] md:text-[50px] sm:text-[40px] text-[28px]">
              Welcome to the Cat Paradise
            </h1>
            <h2 className="lg:text-[45px] md:text-[30px] sm:text-[25px] text-[22px] py-4 italic">
              Meet Our Furry Friends...
            </h2>
            <p className="text-justify max-w-[750px] lg:text-[20px] md:text-[20px] sm:text-[20px] text-[20px]">
        ...
        <div className=" flex items-center justify-center overflow-hidden">
          <img
            ...
            alt="/"
            className="md:max-w-full md:max-h-max sm:max-w-[80vw] absolute md:sticky opacity-75 transform scale-x-[-1] self-end"
          />
        </div>
      </div>
    </div>
